...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (userRegisterForm) {
        userRegisterForm.addEventListener('submit', async (e) => {
            ...
            clearValidation(emailInput);
            clearValidation(contactNumberInput);
            clearValidation(passwordInput);
            ...
            if (!contactNumber) {
                ...
                showError(contactNumberInput, 'Please enter a valid contact number');
                isValid = false;
            }
            ...
            try {
                ...
                showSuccess(emailInput);
                showSuccess(contactNumberInput);
                showSuccess(passwordInput);
        ...
        contactNumberInput.addEventListener('input', () => {
            if (contactNumberInput.value.trim()) {
                if (/^[0-9+\-\s()]{7,15}$/.test(contactNumberInput.value.trim())) {
                    showSuccess(contactNumberInput);
                } else {
                    showError(contactNumberInput, 'Please enter a valid contact number');
                }
