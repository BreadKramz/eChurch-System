...
// Sidebar toggle functionality for dashboards
...
// Tab switching and initial setup
...
// Dashboard navigation and UI management
document.addEventListener('DOMContentLoaded', function() {
            ...
            link.addEventListener('click', (e) => {
                ...
                if (sectionId === 'logout') {
                    if (confirm('Are you sure you want to logout?')) {
                        // Check if we're in admin or user dashboard
                        const isAdmin = document.querySelector('.sidebar-link[data-section="users"]') !== null;
                ...
                sidebarLinks.forEach(l => {
                    if (isAdmin) {
                        ...
                        l.classList.remove('text-white', 'bg-primary/20', 'active');
                        l.classList.add('text-gray-300');
                    } else {
                        // User dashboard styles
                        l.classList.remove('bg-primary/10', 'text-primary', 'border-r-4', 'border-primary');
                ...
                if (isAdmin) {
                    ...
                    link.classList.add('text-white', 'bg-primary/20', 'active');
                } else {
...
// Data management and demo content
let announcements = [
